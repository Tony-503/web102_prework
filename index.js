...
const totalamountraise = GAMES_JSON.reduce( (acc, amount) =>{ 
    return acc + amount.pledged;
}, 0);
// set inner HTML using template literal
raisedCard.innerHTML = `${totalamountraise.toLocaleString('en-US')}`;
...
let displayStr = `A total of $${totalamountraise.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
